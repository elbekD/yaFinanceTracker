...
class TransactionRepo @Inject constructor(/*private val transactionDao: TransactionDao*/) {
    ...
    fun walletTransactions(walletName: String): LiveData<List<Transaction>> {
        return MutableLiveData<List<Transaction>>().apply { value = stubTransactions[walletName] }
        //transactionDao.walletTransactions(walletName)
    }
